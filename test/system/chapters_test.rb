...
class ChaptersTest < ApplicationSystemTestCase
  ...
  test "should create chapter" do
    ...
    fill_in "Content", with: @chapter.content
    fill_in "Image header", with: @chapter.image_header
    fill_in "Subtitle", with: @chapter.subtitle
  ...
  test "should destroy Chapter" do
    visit chapter_url(@chapter)
    accept_confirm { click_on "Destroy this chapter", match: :first }
